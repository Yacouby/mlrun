...
class TestBasicModelMonitoring(TestMLRunSystem):
    ...
    project_name = "pr-basic-model-monitoring11"
    ...
    def test_basic_model_monitoring(self):
        ...
        tracking_policy = mlrun.model_monitoring.tracking_policy.TrackingPolicy(
            default_batch_image="docker.io/yacouby1/mlrun-api:1.5.0",
            stream_image="docker.io/yacouby1/mlrun-api:1.5.0",
        )
        ...
        serving_fn.spec.build.image = "docker.io/yacouby1/mlrun-api:1.5.0"
        serving_fn.spec.image = "docker.io/yacouby1/mlrun-api:1.5.0"
        ...
        # sleep(20)  # not sure if this sleep is needed here
